    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 to-orange-100 flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>Acesse sua conta BarberPro</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="lembrarMe" className="text-sm">
                  Lembrar-me
                </Label>
              </div>
          ...
          <div className="mt-6 p-4 bg-gray-50 rounded-lg">
            <h4 className="text-sm font-semibold text-gray-700 mb-2">Contas de demonstração:</h4>
            <div className="space-y-3 text-xs text-gray-600">
              <div className="border-b border-gray-200 pb-2">
                <div className="font-semibold text-gray-800 mb-1">Barbearias (Managers):</div>
                <div>
                  <strong>Plano Básico:</strong> manager.basico@barberpro.com / 123456
                </div>
                <div>
                  <strong>Plano Profissional:</strong> manager@barberpro.com / 123456
                </div>
                <div>
                  <strong>Plano Premium:</strong> manager.premium@barberpro.com / 123456
                </div>
              </div>
              <div className="border-b border-gray-200 pb-2">
                <div className="font-semibold text-gray-800 mb-1">Funcionários:</div>
                <div>
                  <strong>Barbeiro:</strong> barbeiro@barberpro.com / 123456
                </div>
              </div>
              <div>
                <div className="font-semibold text-gray-800 mb-1">Clientes:</div>
                <div>
                  <strong>Cliente:</strong> cliente@barberpro.com / 123456
                </div>
              </div>
            </div>
          </div>
